...
//go:generate moq -fmt goimports -out mock_kvclientbabysitter_test.go . KvClientBabysitter
//go:generate moq -fmt goimports -out mock_kvendpointclientmanager_test.go . KvEndpointClientManager
