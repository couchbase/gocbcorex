...
func (o KvClientDcpOptions) Equals(b KvClientDcpOptions) bool {
	return o.ConnectionName == b.ConnectionName &&
		...
		o.IncludeXattrs == b.IncludeXattrs &&
		o.ExcludeValues == b.ExcludeValues &&
		o.IncludeDeleteTime == b.IncludeDeleteTime &&
...
func (c *kvClient) bootstrapDcp(
	...
	var connFlags memdx.DcpConnectionFlags = memdx.DcpConnectionFlagsProducer
	if dcpOpts.IncludeXattrs {
		connFlags |= memdx.DcpConnectionFlagsIncludeXattrs
	}
	if dcpOpts.ExcludeValues {
		connFlags |= memdx.DcpConnectionFlagsNoValue
	}
	if dcpOpts.IncludeDeleteTime {
		connFlags |= memdx.DcpConnectionFlagsIncludeDeleteTime
	}
